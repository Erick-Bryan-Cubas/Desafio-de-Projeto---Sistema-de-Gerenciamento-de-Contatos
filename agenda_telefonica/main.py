...
l_nome = Label(frame_cima, text="Agenda Telefónica", height=1,anchor=NE, font=('verdana 17 bold'), bg=co3, fg=co1)
...
def atualizar():
    try:
        ...
        b_confirmar = Button(frame_baixo,command=confirmar, text="Confirmar", width=10, height=1, bg=co2, fg=co4, font=('Ivy 9 bold'), relief=RAISED, overrelief=RIDGE)
...
b_procurara = Button(frame_baixo,command=procurar, text="Procurar", height=1, bg=co2, fg=co4, font=('Ivy 8 bold'), relief=RAISED, overrelief=RIDGE)
...
b_ver = Button(frame_baixo,command=mostrar, text="Ver dados",width=10, height=1, bg=co2, fg=co4, font=('Ivy 8 bold'), relief=RAISED, overrelief=RIDGE)
b_ver.place(x=290, y=50)

b_adicionar = Button(frame_baixo,command=inserir, text="Adicionar", width=10, height=1, bg=co2, fg=co4, font=('Ivy 9 bold'), relief=RAISED, overrelief=RIDGE)
b_adicionar.place(x=400, y=50)

b_atualizar = Button(frame_baixo,command=atualizar, text="Atualizar", width=10, height=1, bg=co7, fg=co1, font=('Ivy 9 bold'), relief=RAISED, overrelief=RIDGE)
b_atualizar.place(x=400, y=80)

b_deletar = Button(frame_baixo,command=remover, text="Deletar", width=10, height=1, bg=co6, fg=co1, font=('Ivy 9 bold'), relief=RAISED, overrelief=RIDGE)
